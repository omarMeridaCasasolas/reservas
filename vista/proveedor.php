...
<body>
    ...
    <main class="container border shadow p-4 mb-4 mx-auto my-1 bg-white" style="min-height: 650px;">
        <h1 class="text-center p-2 text-primary">Lista de proveedores</h1>
        <div>
            <button class="btn btn-success" data-toggle='modal' data-target='#modalAgregarProveedor'>Agregar Empleado</button>
        </div>
        <br>
        <br>
        <div class="table-responsive">
            <table id="tablaProveedor" class="table compact bordered table-hover" style="width:100%">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Telefono</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" id="formDeletProveedor">
                        <span class="d-none" id="idDeletProveedor"></span>
                        <p>¿Usted esta seguro que desea eliminar el proveedor <strong id="nomDeletProveedor"></strong>?</p>
                        <br>
